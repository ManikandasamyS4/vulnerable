pipeline {
    ...
    environment {
        ...
        BURP_REPORT_FILE_PATH = 'C:/Users/Manikandasamy/Documents/zap-reports/Burp/report.xml' // Path where the report will be saved
    }
    stages {
        stage('Checkout') {
            steps {
            ...
            steps {
                script {
                    bat """
                        ...
                        -e BURP_REPORT_FILE_PATH='C:/Users/Manikandasamy/Documents/zap-reports/Burp/report.xml' ^
    ...
    post {
        always {
            junit 'dastardly-report.xml', skipPublishingChecks: true
        }
    }
}
